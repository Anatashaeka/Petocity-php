...
<section class ="judul">
    ...
    <section class ="isian">
          <div class="card container w-50 border-0 bg-transparent">
            <div class="card-body">
            <form action="<?php echo base_url('Controller/create_processPickup'); ?>" method ="post"><br> 
                    ...
                    <textarea class="form-control" name="kondisi" placeholder="Keadaan Hewan" rows="3" required></textarea><br>               
