...
<html lang="en">
  <head>
    <title>Update Pesanan Obat</title>
    <meta charset="utf-8">
...
<section class ="judul">
<h1 class ="edit"><b>Edit Pesanan Obat</b></h1>
    <svg class = "kiri"> 
    </svg>
          
          <div class="container">
            <img src="../../images/order.jpg" class="mx-auto d-block" style="width:55%"> 
          </div>
    ...
    <section class ="isian">
          <div class="card container w-50 border-0 bg-transparent">
            <div class="card-body">
            <form action="<?php echo base_url('Controller/update_process'); ?>" method ="post"><br> 
      ...
      <label>
       Recipe : <input type="text" class="form-control form-control-lg" id="colFormLabelLg" name="resep" autofocus value = "<?= $update ['resep']; ?>">
        </label><br>
      <label>
      <label>
        Foto:<br>
        <textarea class="form-control form-control-lg" id="colFormLabelLg" name="foto"><?= $update ['foto']; ?></textarea>
      </label><br>
      <label>
        Address:
