 ...
 <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            ...
            <form class="d-flex">
              ...
              <a type="button" class="btn btn-outline-dark" style="margin-right: 10px;" href="<?php echo base_url('Controller/createlogin/'); ?>" role="button">Register</a>
            </form>
          </div>
        </div>
      </nav>
    ...
    <div id="card">
        <div id="card-content">
            ...
            <form action="<?php echo base_url('Controller/home'); ?>" method="post" class="form">
                ...
                <input
                    ...
                    required >
                <div class="form-border"></div>
                <p><input type='checkbox'/>Ingat saya</p>
                <!-- <input id="submit-btn" type="submit" name="submit" value="LOGIN" /> -->
                <input id="submit-btn" type="submit" value="login" class="btn btn-primary">
                <a href="<?php echo base_url('Controller/lupa/'); ?>" legend id="forgot-pass">Lupa kata sandi Anda?</a>
            </form>
    </div>
    </div>
