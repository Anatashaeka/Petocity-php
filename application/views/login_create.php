 ...
 <body>
    ...
    <div id="card-regist">
        <div id="card-content">
            ...
            <form action="<?php echo base_url('Controller/create_processlogin'); ?>" method="post" class="form">
                <label for="user-fullname" style="padding-top:3px">&nbsp;Nama Lengkap</label>
                <input
                    id="user-fullname"
                    class="form-content"
                    type="text"
                    ...
                    autocomplete="on"
                    required />
                <label for="user-email" style="padding-top:3px">&nbsp;Email</label>
                <input
                    id="user-email"
                    class="form-content"
                    type="email"
                    ...
                    autocomplete="on"
                    required />
                <label for="user-password" style="padding-top:5px">&nbsp;Kata Sandi</label>
                <input
                    id="user-password"
                    class="form-content"
                    type="password"
                    name="Kata-Sandi"
                    required />
                <label for="user-alamat" style="padding-top:3px">&nbsp;Alamat</label>
                <input
                    id="user-alamat"
                    class="form-content"
                    type="text"
                    ...
                    autocomplete="on"
                    required />
                <label for="user-nohp" style="padding-top:3px">&nbsp;No.HP</label>
                <input
                    id="user-nohp"
                    class="form-content"
                    type="text"
                ...
                <a href="<?php echo base_url('Controller/login/'); ?>" legend id="forgot-pass">Telah memiliki akun?</a>
            </form>
    </div>
    </div>
